...
//!
//! This is Clack's fork of `ratatui-crossterm` 0.1.2. It exclusively uses
//! `clack-crossterm` so rendering, cursor queries, raw mode, and event parsing
//! share one terminal implementation. The backend implementation is unchanged.
//!
//! [Ratatui]: https://ratatui.rs
//! [Crossterm]: https://crates.io/crates/clack-crossterm
